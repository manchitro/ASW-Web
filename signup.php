...
<div class="banner-signup">
	...
	<div class="agileits-top">
		<form action="includes/signup.inc.php" method="post">
			...
			?>
			<input class="text" type="text" name="academicid" id="academicid" placeholder="Academic ID (XXXX-XXXX-X)" required title="XXXX-XXXX-X format required" pattern="^\d{4}-\d{4}-[1-3]$" value="<?php echo(isset($_GET['academicid']))?$_GET['academicid']:''?>" autocomplete="off">
			...
			<input class="text" type="password" name="password" id="password" placeholder="Password" required title="Password has to be at least 6 characters long. Mix of uppercase, lowercase, numbers is recommended!" pattern=".{6,}" autocomplete="off">
