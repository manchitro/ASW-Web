		...
		<div class="inner">
			...
			<div class="flex ">
				...
				<form action="includes/signup.inc.php" method="post">
					...
					<input class="text-email" type="email" name="email" id="email" placeholder="Academic Email (@aiub.edu)" required title="You need an aiub.edu email to sign up" pattern="^[A-Za-z0-9._%+-]+@aiub\.edu$" value="<?php echo(isset($_GET['email']))?$_GET['email']:''?>">
